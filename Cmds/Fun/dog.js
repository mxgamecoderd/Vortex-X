...
module.exports = async (context) => {
    ...
    try {
        ...
        const imageResponse = await axios.get('https://ip2.onrender.com/api/images/naruto');
        ...
        if (imageResponse.data.images && imageResponse.data.images.length > 0) {
            ...
            // Prepare the message
            const message = `
                Hello ${m.pushName}, here is a random Naruto image for you! 🖼️\n\n
                Category: NARUTO\n\n
                Type ${prefix}menu to see my full command list.
            `;
        ...
        await client.sendMessage(m.chat, { text: 'Sorry, I couldn\'t fetch a Naruto image at the moment.' });
    }
};
